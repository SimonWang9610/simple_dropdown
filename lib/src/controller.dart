...
/// Used to store the search history of the items.
mixin class _ItemSearchHistoryBucket<T> {
  final Map<Object, _MatchPair<T>> _history = {};
  final List<Object> _order = [];

  /// Add the given items to the history with the given key.
  /// if existed, it will be removed first and then added to mark it as the top history.
  ...
  /// Remove the history with the given key.
